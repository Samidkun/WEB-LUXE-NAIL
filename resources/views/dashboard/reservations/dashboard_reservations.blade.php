...
@section('content')
                ...
                <div class="modal-body bg-light p-4">
                    <div class="row">
                        <div class="col-md-7 text-center border-end">
                            ...
                            <img id="proofImage" src="" class="img-fluid rounded shadow-sm"
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="mb-3">
                                <small class="text-uppercase text-muted fw-bold" style="font-size: 0.7rem;">Invoice
                                    Number</small>
                                <div class="fs-5 fw-bold text-dark" id="modalQueue"></div>
                            </div>

                            <div class="mb-3">
                                <small class="text-uppercase text-muted fw-bold" style="font-size: 0.7rem;">Customer
                                    Name</small>
                            ...
                            <div class="mb-4">
                                <small class="text-uppercase text-muted fw-bold" style="font-size: 0.7rem;">Date &
                                    Time</small>
    ...
    <script>
        ...
        setInterval(function () {
            location.reload();
        }, 20000); // Auto-refresh every 20 seconds (critical page)
    </script>
