    ...
    <div class="card-body p-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            ...
            <form action="{{ route('dashboard') }}" method="GET"
                  class="d-flex flex-wrap gap-2 align-items-center" id="incomeFilterForm">
                        ...
                        <div class="artist-card mb-3 p-3 rounded-3">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <small class="text-muted">Completed: {{ $artist->completed_reservations ?? 0 }}</small><br>
                                    <small class="text-muted">Income: Rp {{ number_format($artist->total_income ?? 0, 0, ',', '.') }}</small>
                                </div>
                                <span class="badge">
