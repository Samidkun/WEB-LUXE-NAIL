                    ...
                    <div class="card shadow-lg border-0 rounded-4">
                        <div class="card-body p-5">
                            <div class="text-center mb-4">
                                ...
                                <p class="text-muted">Enter your Invoice Number to check your payment status.</p>
                            </div>
                            ...
                            <form action="{{ route('payment.check_invoice') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="queue_number" class="form-control form-control-lg"
                                        placeholder="e.g. LX2025..." required>
                                    @error('queue_number')
                                ...
                                <button type="submit" class="btn w-100 py-3 fw-bold text-white"
                                    style="background: #d889a6; border-radius: 10px;">
                                    Check Status
                                </button>
                            </form>
                        </div>
